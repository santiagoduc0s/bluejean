...
List<SingleChildWidget> providerUseCases = [
  ...
  ...[
    Provider<SignInWithEmailPasswordUseCase>(
      create:
          (context) => SignInWithEmailPasswordUseCase(
    ...
    Provider<SignInWithAppleUseCase>(
      create:
          (context) => SignInWithAppleUseCase(
            authRepository: context.read(),
            deviceRepository: context.read(),
            userPreferenceRepository: context.read(),
          ),
    ...
    Provider<SignUpUseCase>(
      create: (context) => SignUpUseCase(authRepository: context.read()),
    ),
    Provider<ForgotPasswordUseCase>(
      create: (context) => ForgotPasswordUseCase(context.read()),
    ),
    Provider<UpdateCurrentUserUsecase>(
      create:
          (context) => UpdateCurrentUserUsecase(
            authRepository: context.read(),
    ...
    Provider<DeleteAccountUsecase>(
      create: (context) => DeleteAccountUsecase(authRepository: context.read()),
    ),
  ],
