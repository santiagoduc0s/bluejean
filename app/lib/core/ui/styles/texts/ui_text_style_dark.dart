...
class UITextStyleDark extends UITextStyle {
  ...
  TextStyle get displayLarge {
    return baseTextStyle.copyWith(fontSize: 57);
  }

  @override
  TextStyle get displayMedium {
    return baseTextStyle.copyWith(fontSize: 45);
  }
  ...
  TextStyle get headlineLarge {
    return baseTextStyle.copyWith(fontSize: 32);
  }
  ...
  TextStyle get headlineSmall {
    return baseTextStyle.copyWith(fontSize: 24);
  }

  @override
  TextStyle get titleLarge {
    return baseTextStyle.copyWith(fontSize: 22);
  }
  ...
  TextStyle get labelMedium {
    return baseTextStyle.copyWith(fontSize: 12);
  }

  @override
  TextStyle get labelSmall {
    return baseTextStyle.copyWith(fontSize: 11);
  }
